...
func AuthGetAcessTokenMultipleAccountstresdias(c *gin.Context) {
	config = &oauth2.Config{
		ClientID:     "459162752034-80q8hukn6eu45nt4fi0sic5ac51vc3ks.apps.googleusercontent.com", // Substitua pelo seu Client ID
		ClientSecret: "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",                                      // Substitua pelo seu Client Secret
...
func OAuth2CallbackMultipleAccountstresdias(c *gin.Context) {
...
func GetGoogleAdsDataForMultipleAccountstresdias(c *gin.Context) {
	...
	err = sheets.WriteToGoogleSheetstres(ctx, accessToken, allCampaigns)
	if err != nil {
